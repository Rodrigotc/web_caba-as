         ...
         <form method="POST" action="./Backend/enviarcomentario.php">
          <div class="form-group">
            <div class="input-group input-group-sm mb-3">
              <span for="nombre" class="input-group-text" id="inputGroup-sizing-sm">Usuario</span>
              <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="nombre" type="text" id="nombre" value="<?php echo $nombrePersona ?>" required readonly >
            </div>
            <div class="input-group input-group-sm mb-3">
              <span for="idcabana" class="input-group-text" id="inputGroup-sizing-sm">Id cabaña</span>
              <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="idcabana" type="text" id="idcabana" value="<?php echo $solicitud["Cabana_idCabana"] ?>" required readonly >
            </div>
