...
<body>
    ...
    if (isset($_POST['Direccion'])) {
        ...
        //Campos vacíos
        if ($Titulo == "" || $Direccion == "" || $nroPiezas == "" || $Descripcion == "" || $Precio == "") {
        ...
        if (count($errores) > 0) {
            ...
            $insertar = "INSERT INTO `nuevocabanasdb`.`cabana` (`Ciudad`, `Estado`, `Titulo`, `NroPiezas`, `Precio`, `Descripcion`, `Direccion`, `Latitud`, `Longitud`, `Wifi`, `Estacionamiento`, `Quincho`, `Piscina`, `Bodega`, `CalefaccionGas`, `CalefaccionElectrica`, `CombustionLenta`, `Persona_idPersona`) VALUES ('$Ciudad', '0', '$Titulo' , '$nroPiezas', '$Precio', '$Descripcion', '$Direccion' , '$lat' , '$lng' , '$Wifi' , '$Estacionamiento', '$Quincho', '$Piscina', '$Bodega', ' $CalefaccionGas', '$CalefaccionElectrica', '$CalefaccionLenta', '$idPersona');";
    ...
    <div class="container-form-ingresarcab">
        <div style=" font-size:1.1rem; font-style: italic; color:white ; --bs-gutter-x: 0rem; height: 100vh;" class="row">
            <div style="border: 2px dashed black;" class="col">
                <div class="container-select-input p-3">
                    <form action="IngresoCabana.php" method="POST" enctype="multipart/form-data">
                        Título<br>
                        <input class="input-group input-group-sm mb-1" name="Titulo" id="Titulo" placeholder="Título de publicación" value="<?php echo $Titulo; ?>"><br>
                        Ciudad<br>
                ...
                <div class="container-filtros p-3">
                    <section>
                        ...
                        <div class="form-check">
                            <label class="form-check-label" for=""><input class="form-check-input" type="checkbox" name="Wifi" id="Wifi" <?php echo $Wifi; ?>>Wifi</label><br>
                        </div>
