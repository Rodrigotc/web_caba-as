...
<footer class="footer-distributed">
      ...
      <img src="Imagenes/CabLagos_Logo.png" class="img-footer" alt="puerto-imagen">
				...
				<p class="footer-company-name">Cab-lagos © 2022</p>
			</div>
			...
			<div class="footer-center">
				...
				<div>
					...
					<p>direccion: Solana Beach, California</p>
				</div>

				<div>
					<i class="fa fa-phone"></i>
					<p>numero: +569 2212 5422</p>
				</div>

				<div>
					<i class="fa fa-envelope"></i>
					<p><a href="mailto:support@company.com">cablagos@contacto.com</a></p>
				</div>
